...
| Slug | Course | Status |
|------|--------|--------|
| `cndc` | CSC 3205 Data Communication and Computer Networks (Dr. Maria Zuraiz; instructor slides call it DCCN) | Outline in hand. Weeks 1 to 4 built. Lectures 01 to 10 uploaded (lecture 05 missing). Dr. Zuraiz teaches from Rana Faisal Hayat's slides, so his name on a deck is expected, not a different instructor. Assignment 1 (due 2026-09-28) guidance is in the week-2 checkpoint. |
